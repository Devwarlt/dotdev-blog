				...
				<div class="d-flex justify-content-center">
					<div class="alert alert-warning border-danger bg-danger text-light fade show col-sm-12">
						...
						<p class="mb-0 small" style="text-justify: inter-word; text-align: justify">
							A página <code
									class="link-warning bg-dark rounded-2 shadow-sm"><?php
									echo $_SERVER["REQUEST_URI"]; ?></code> não existe ou foi movida para outro
							diretório. Caso esse erro persista, entre em contato com o administrador do sistema através
							do contato abaixo.
						</p>
