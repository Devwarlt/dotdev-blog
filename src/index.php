...
if (isset($_SERVER["HTTP_REFERER"]) && $_SERVER["HTTP_REFERER"] !== $_SERVER["REQUEST_URI"]) utils::getSingleton()->flushResponseCookies();
                    ...
                    <ul class="list-group list-group-flush small">
                        ...
                        <li class="list-group-item btn-sm btn-outline-success">
                            <a class="btn btn-sm" role="button" href="/my_posts">
                                <span class="glyphicon glyphicon-search small"></span> <small>Minhas postagens</small>
                            </a>
                        </li>
