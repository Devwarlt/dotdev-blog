				...
				echo sprintf("
					...
					<body style='height: 100%%;' class='h-100 row align-items-center  alert-light'>
					    <div class='card text-white bg-danger' style='padding: 4px; width: 100%%'>
					        ...
					        <div class='card-footer'>
					            <h5>PDO::errorInfo():</h5>
					            <p><small><strong>&blacktriangleright;&nbsp;SQLSTATE Error Code:</strong> %s</small></p>
					            <p><small><strong>&blacktriangleright;&nbsp;Driver-specific Error Code:</strong> %s</small></p>
					            <p><small><strong>&blacktriangleright;&nbsp;Driver-specific Error Message:</strong> %s</small></p>
					        </div>
					    </div>
					    <hr/>
					    <script type='text/javascript' src='../../../js/bootstrap.min.js'></script>
