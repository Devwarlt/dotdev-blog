...
if (login::getSingleton()->isUserSignedUp()) {
    utils::getSingleton()->onRedirectOk(
        "Você já está registrado no sistema, não é necessário realizar outro cadastro.",
        "/"
    );
    return;
}
            ...
            <div class="card-body scrollable">
                <form action="php/MVCRouter" method="post">
                    ...
                    <div class="form-group row mt-2">
                        <span class="col-sm-3 glyphicon
                            glyphicon-lock d-flex justify-content-center"></span>
                        <div class="col-sm-8">
